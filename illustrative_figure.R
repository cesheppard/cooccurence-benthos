...
g <- ggplot()+
  ...
  annotate("text", x=0.44, y=6, label="Interaction Effect", hjust="inward", angle = 90, size=9)+
  annotate("text", x=0.44, y=2.5, label="Identity Effect", hjust="inward", angle = 90, size=9)+
  annotate("text", x=0.99, y=4, label="Identity effect of species i", hjust="inward", size=9)+
  ...
  theme(legend.title=element_blank(), legend.position="none",
        ...
        plot.margin = unit(c(1.5,20,1,1), "lines"), text = element_text(size=30),
