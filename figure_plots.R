...
g17 <- ggplot()+
  ...
  geom_line(data = predict.mean, aes(x=P1, y=fleshyid*100, group = Group, col = Group), size = 2, linetype = "dashed")+
  scale_colour_manual(values=group.colours)+
  geom_vline(xintercept=0.2, linetype = "dotted")+
...
g18 <- ggplot()+
  ...
  geom_line(data = predict.mean, aes(x=P1, y=calcid*100, group = Group, col = Group), size = 2, linetype = "dashed")+
  scale_colour_manual(values=group.colours)+
  geom_vline(xintercept=0.2, linetype = "dotted")+
  geom_point(aes(x=0.22,y=5), shape = 18, size = 2)+
...
g19 <- ggplot()+
  ...
  geom_line(data = predict.mean, aes(x=P1, y=turfid*100, group = Group, col = Group), size = 2, linetype = "dashed")+
  scale_colour_manual(values=group.colours)+
  geom_vline(xintercept=0.2, linetype = "dotted")+
...
g20 <- ggplot()+
  ...
  geom_line(data = predict.mean, aes(x=P1, y=ccaid*100, group = Group, col = Group), size = 2, linetype = "dashed")+
  scale_colour_manual(values=group.colours)+
  geom_vline(xintercept=0.2, linetype = "dotted")+
  geom_point(aes(x=0.22, y=9.5), shape=18, size=2)+
  scale_y_continuous(name = "CCA Cover (%)", limits = c(0,100))+
  annotate("text", x=0, y=100, label="h. CCA cover", hjust=0, size=9)+
  xlab("Proportional Abundance")+
  theme(legend.title=element_blank(), legend.position="none", legend.key = element_rect(fill = "white"),
...
g22 <- ggplot()+
  ...
  xlab(NULL)+
  ylab(bquote("Calcification Rate (kg CaCO"[3]*"m"^-2*"year"^-1*")"))+
  annotate("text", x=0, y=6, label="c. Calcification rate",hjust=0, size=9)+
  theme(legend.title=element_blank(), legend.position="none",
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        axis.text.x = element_blank(), text = element_text(size=20))
